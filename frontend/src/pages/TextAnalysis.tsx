  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F5F0E8] pt-8 pb-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        {/* Header */}
        <div className="mb-10">
          <span className="font-black text-[#0a0a0a] uppercase tracking-widest border-2 border-[#0a0a0a] bg-[#D6EEFF] px-3 py-1 rounded shadow-[2px_2px_0_#0a0a0a] text-xs inline-block mb-4">
            Text Module
          </span>
